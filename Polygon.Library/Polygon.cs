namespace Polygon.Library
{
    ...
    public class Circle : Polygon//класс для вычисления площади круга (2*pi*r), массив вершин имеет длину в 2 элемента (центр окружности и точка на окружности), поле для константы пи, перегрузка метода вычисления площади 
    {
